...
namespace fc::vm::actor::builtin {
  ...
  struct PowerActor {
    ...
    struct CreateMiner : ActorMethodBase<Method::kCreateMiner> {
    ...
    struct UpdateClaimedPower : ActorMethodBase<Method::kUpdateClaimedPower> {
      struct Params {
    ...
    CBOR_TUPLE(UpdateClaimedPower::Params,
               raw_byte_delta,
               quality_adjusted_delta)

    struct EnrollCronEvent : ActorMethodBase<Method::kEnrollCronEvent> {
      struct Params {
    ...
    struct UpdatePledgeTotal : ActorMethodBase<Method::kUpdatePledgeTotal> {
      using Params = TokenAmount;
    };

    struct OnConsensusFault : ActorMethodBase<Method::kOnConsensusFault> {
      using Params = TokenAmount;
    };

    struct SubmitPoRepForBulkVerify
        : ActorMethodBase<Method::kSubmitPoRepForBulkVerify> {
      using Params = SealVerifyInfo;
    };

    struct CurrentTotalPower : ActorMethodBase<Method::kCurrentTotalPower> {
      struct Result {
