...
namespace fc::vm::actor::builtin {
  ...
  struct VerifiedRegistryActor {
    ...
    struct AddVerifier : ActorMethodBase<Method::kAddVerifier> {
      struct Params {
        Address address;
        DataCap allowance;
    ...
    struct RemoveVerifier : ActorMethodBase<Method::kRemoveVerifier> {
      using Params = Address;
    };

    struct AddVerifiedClient : ActorMethodBase<Method::kAddVerifiedClient> {
      struct Params {
        Address address;
        DataCap allowance;
    ...
    struct UseBytes : ActorMethodBase<Method::kUseBytes> {
      struct Params {
        Address address;
    ...
    struct RestoreBytes : ActorMethodBase<Method::kRestoreBytes> {
      struct Params {
        Address address;
        StoragePower deal_size;
    ...
    struct RemoveVerifiedClientDataCap
        : ActorMethodBase<Method::kRemoveVerifiedClientDataCap> {
      struct Params {
