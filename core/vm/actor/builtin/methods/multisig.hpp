...
namespace fc::vm::actor::builtin {
  ...
  struct MultisigActor {
    ...
    struct Propose : ActorMethodBase<Method::kPropose> {
      struct Params {
        Address to;
        TokenAmount value;
        MethodNumber method{};
        ...
        inline bool operator==(const Params &other) const {
          return to == other.to && value == other.value
                 && method == other.method && params == other.method;
        }
    ...
    struct Approve : ActorMethodBase<Method::kApprove> {
      struct Params {
        TransactionId tx_id{};
        Bytes proposal_hash;
    ...
    struct Cancel : ActorMethodBase<Method::kCancel> {
      struct Params {
        TransactionId tx_id{};
        Bytes proposal_hash;
    ...
    struct AddSigner : ActorMethodBase<Method::kAddSigner> {
      struct Params {
        Address signer;
    ...
    struct RemoveSigner : ActorMethodBase<Method::kRemoveSigner> {
      struct Params {
        Address signer;
    ...
    struct SwapSigner : ActorMethodBase<Method::kSwapSigner> {
      struct Params {
        Address from;
        Address to;
    ...
    struct ChangeThreshold : ActorMethodBase<Method::kChangeThreshold> {
      struct Params {
    ...
    struct LockBalance : ActorMethodBase<Method::kLockBalance> {
      struct Params {
        ChainEpoch start_epoch{};
        EpochDuration unlock_duration{};
        TokenAmount amount;
