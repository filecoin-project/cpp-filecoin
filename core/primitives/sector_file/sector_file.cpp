...
namespace fc::primitives::sector_file {
  ...
  outcome::result<uint64_t> sealSpaceUse(SectorFileType file_type, RegisteredProof seal_proof_type) {
      OUTCOME_TRY(sector_size, fc::primitives::sector::getSectorSize(seal_proof_type));
...
OUTCOME_CPP_DEFINE_CATEGORY(fc::primitives::sector_file, SectorFileTypeErrors, e) {
