...
#ifndef CPP_FILECOIN_BLOCK_STORE_HPP
#define CPP_FILECOIN_BLOCK_STORE_HPP
...
namespace fc::storage::blockchain {
  class BlockStore {
      ...
      virtual outcome::result<common::Buffer> get(const DatastoreKey &key) const = 0;
      /** @brief set key -> value */
...
#endif  // CPP_FILECOIN_BLOCK_STORE_HPP
