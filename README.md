...
you also can download that [snapshots](https://fil-chain-snapshots-fallback.s3.amazonaws.com/mainnet/minimal_finality_stateroots_latest.car "snapshote store") for a less time-assuming connection and synchronisation to the popular filecoin networks.
...
8. node executable can be found at: `<build_repository>/core/node/main`.
9. miner executable can be found at:
   `<build_repository>/core/miner/main`
10. next steps are similar to common miner and node establishing which can be found at **Fuhon node establishing** and **Fuhon miner establishing**
