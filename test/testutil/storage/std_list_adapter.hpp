...
#ifndef CPP_FILECOIN_STD_LIST_ADAPTER_HPP
#define CPP_FILECOIN_STD_LIST_ADAPTER_HPP
...
namespace test {
  ...
  using fc::face::ForwardIterator;
  using fc::face::GenericIterator;
  using fc::face::GenericList;
  ...
  class StdListIterator : public GenericIterator<GenericList<T>> {
   ...
   public:
    ...
    fc::face::GenericIterator<GenericList<T>> &operator++() override {
      it_++;
      return *this;
    }
...
#endif  // CPP_FILECOIN_STD_LIST_ADAPTER_HPP
