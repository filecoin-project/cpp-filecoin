 ...
 */
    TEST_F(ProofsTest, Lifecycle) {
        ...
        EXPECT_OUTCOME_TRUE_1(
                ProofParamProvider::getParams(params_, sector_size));
        ...
        EXPECT_OUTCOME_TRUE_1(proofs_->unseal(seal_proof_type,
                                             sector_cache_dir_path,
                                             sealed_sector_file,
        ...
        EXPECT_OUTCOME_TRUE(
                proofs, proofs_->generateWinningPoSt(miner_id, private_info, randomness));
