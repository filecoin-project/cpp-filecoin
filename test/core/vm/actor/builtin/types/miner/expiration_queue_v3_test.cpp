...
namespace fc::vm::actor::builtin::v3::miner {
  ...
  TEST_F(ExpirationQueueTestV3, AddedSectorsCanBePoppedOffQueue) {
  ...
  TEST_F(ExpirationQueueTestV3, QuantizesAddedSectorsByExpiration) {
  ...
  TEST_F(ExpirationQueueTestV3, ReschedulesSectorsToExpireLater) {
  ...
  TEST_F(ExpirationQueueTestV3, ReschedulesSectorsAsFaults) {
  ...
  TEST_F(ExpirationQueueTestV3, ReschedulesAllSectorsAsFaults) {
    eq.quant = QuantSpec(4, 1);
    EXPECT_OUTCOME_TRUE_1(eq.addActiveSectors(sectors, ssize));
  ...
  TEST_F(ExpirationQueueTestV3, RescheduleExpirationsThenRescheduleAsFault) {
    eq.quant = QuantSpec(4, 1);
    EXPECT_OUTCOME_TRUE_1(eq.addActiveSectors(sectors, ssize));
  ...
  TEST_F(ExpirationQueueTestV3, RescheduleRecoverRestoresAllSectorStats) {
    eq.quant = QuantSpec(4, 1);
    EXPECT_OUTCOME_TRUE_1(eq.addActiveSectors(sectors, ssize));
  ...
  TEST_F(ExpirationQueueTestV3, ReplacesSectorsWithNewSectors) {
    eq.quant = QuantSpec(4, 1);
  ...
  TEST_F(ExpirationQueueTestV3, RemovesSectors) {
    eq.quant = QuantSpec(4, 1);
    EXPECT_OUTCOME_TRUE_1(eq.addActiveSectors(sectors, ssize));
  ...
  TEST_F(ExpirationQueueTestV3, AddingNoSectorsLeavesTheQueueEmpty) {
    eq.quant = QuantSpec(4, 1);
  ...
  TEST_F(ExpirationQueueTestV3, ReschedulingNoExpirationsLeavesTheQueueEmpty) {
    eq.quant = QuantSpec(4, 1);
