...
#include "core/vm/actor/builtin/types/miner/expected_deadline_v3.hpp"
...
namespace fc::vm::actor::builtin::v3::miner {
  ...
  struct MinerActorStateTestV3 : testing::Test {
    void SetUp() override {
  ...
  TEST_F(MinerActorStateTestV3, PrecommittedSectorsStorePutGetAndDelete) {
    const auto pc1 =
  ...
  TEST_F(MinerActorStateTestV3, SectorsStorePutGetAndDelete) {
  ...
  TEST_F(MinerActorStateTestV3, TestVesting) {
  ...
  TEST_F(MinerActorStateTestV3, LockedfundsIncreasesWithSequentialCalls) {
  ...
  TEST_F(MinerActorStateTestV3, UnlockAllUnvestedFunds) {
    const VestSpec vspec{.initial_delay = 0,
                         .vest_period = 5,
                         .step_duration = 1,
                         .quantization = 1};
  ...
  TEST_F(MinerActorStateTestV3, SuccessfullyAddAProofToPreCommitExpiryQueue) {
  ...
  TEST_F(MinerActorStateTestV3, AssignSectorsToDeadlines) {
    ...
    EXPECT_OUTCOME_TRUE_1(state.assignSectorsToDeadlines(
  ...
  TEST_F(MinerActorStateTestV3, CantAllocateTheSameSectorNumberTwice) {
  ...
  TEST_F(MinerActorStateTestV3, CanMaskSectorNumbers) {
    EXPECT_OUTCOME_TRUE_1(state.allocateSectorNumber(sector_num));
  ...
  TEST_F(MinerActorStateTestV3, CantAllocateOrMaskOutOfRange) {
    EXPECT_OUTCOME_ERROR(VMExitCode::kErrIllegalArgument,
  ...
  TEST_F(MinerActorStateTestV3, CanAllocateInRange) {
  ...
  TEST_F(MinerActorStateTestV3, RepayDebtInPriorityOrder) {
