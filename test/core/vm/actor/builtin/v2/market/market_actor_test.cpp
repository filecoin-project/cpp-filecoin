...
namespace fc::vm::actor::builtin::v2::market {
  ...
  ClientDealProposal MarketActorTest::setupPublishStorageDeals() {
    ...
    proposal.proposal = Universal<DealProposal>(ActorVersion::kVersion2);
  ...
  TEST_F(MarketActorTest, PublishStorageDealsDifferentProviders) {
    ...
    proposal2.proposal = Universal<DealProposal>(ActorVersion::kVersion2);
  ...
  TEST_F(MarketActorTest, OnMinerSectorsTerminateNotDealMiner) {
    auto deal = Universal<DealProposal>(ActorVersion::kVersion2);
